...
pub async fn authenticate(server_url: &str, redirect_uri: &str) -> Result<String, Box<dyn std::error::Error + Send + Sync>> {
    ...
    let server: Server = HttpServer::new(move || {
        ...
        App::new().data(token_for_route).route("/", web::get().to(|req: web::Query<HashMap<String, String>>, token: web::Data<Arc<Mutex<Option<String>>>>| async move {
